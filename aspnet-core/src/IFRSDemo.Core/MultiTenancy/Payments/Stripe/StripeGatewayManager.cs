...
{
    public class StripeGatewayManager : IFRSDemoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "IFRSDemo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + IFRSDemoConsts.Currency;
        }
