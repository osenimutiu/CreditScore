...
using IFRSDemo.Authorization.Ldap;
using IFRSDemo.Authorization.Roles;
using IFRSDemo.Authorization.Users;
using IFRSDemo.Chat;
using IFRSDemo.Configuration;
using IFRSDemo.DashboardCustomization.Definitions;
using IFRSDemo.Debugging;
using IFRSDemo.DynamicEntityProperties;
using IFRSDemo.Features;
using IFRSDemo.Friendships;
using IFRSDemo.Friendships.Cache;
using IFRSDemo.Localization;
using IFRSDemo.MultiTenancy;
using IFRSDemo.Net.Emailing;
using IFRSDemo.Notifications;
using IFRSDemo.WebHooks;

namespace IFRSDemo
{
    [DependsOn(
        typeof(IFRSDemoCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class IFRSDemoCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            IFRSDemoLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = IFRSDemoConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, IFRSDemoMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<IFRSDemoSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(IFRSDemoCoreModule).GetAssembly());
        }
