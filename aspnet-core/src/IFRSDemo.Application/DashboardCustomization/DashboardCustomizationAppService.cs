...
using IFRSDemo.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace IFRSDemo.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : IFRSDemoAppServiceBase, IDashboardCustomizationAppService
    {
