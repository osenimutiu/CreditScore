...
using IFRSDemo.Auditing.Exporting;
using IFRSDemo.Authorization;
using IFRSDemo.Authorization.Users;
using IFRSDemo.Dto;
using IFRSDemo.EntityHistory;
using EntityHistoryHelper = IFRSDemo.EntityHistory.EntityHistoryHelper;

namespace IFRSDemo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : IFRSDemoAppServiceBase, IAuditLogAppService
    {
