...
namespace IFRSDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : IFRSDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<IFRSDemoDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{IFRSDemoConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{IFRSDemoConsts.ConnectionStringName}", constring);
        }
