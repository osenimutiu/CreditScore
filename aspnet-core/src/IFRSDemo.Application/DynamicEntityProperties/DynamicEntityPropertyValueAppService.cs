...
using IFRSDemo.DynamicEntityPropertyValues.Dto;

namespace IFRSDemo.DynamicEntityProperties
{
    [Authorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : IFRSDemoAppServiceBase, IDynamicEntityPropertyValueAppService
    {
