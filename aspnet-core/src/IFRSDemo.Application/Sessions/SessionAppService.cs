...
{
    public class SessionAppService : IFRSDemoAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = IFRSDemoConsts.Currency,
                    CurrencySign = IFRSDemoConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = IFRSDemoConsts.AllowTenantsToChangeEmailSettings,
