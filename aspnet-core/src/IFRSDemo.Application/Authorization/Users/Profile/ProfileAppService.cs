...
using IFRSDemo.Authorization.Users.Profile.Cache;
...
using IFRSDemo.Security;
using IFRSDemo.Storage;
using IFRSDemo.Timing;

namespace IFRSDemo.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : IFRSDemoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("IFRSDemo",
