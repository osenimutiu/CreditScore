...
using IFRSDemo.DemoUiComponents.Dto;

namespace IFRSDemo.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : IFRSDemoAppServiceBase, IDemoUiComponentsAppService
    {
