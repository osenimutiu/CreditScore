...
using IFRSDemo.Web.Startup.ExternalLoginInfoProviders;

namespace IFRSDemo.Web.Startup
{
    [DependsOn(
        typeof(IFRSDemoWebCoreModule)
    )]
    public class IFRSDemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public IFRSDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(IFRSDemoWebHostModule).GetAssembly());
        }
