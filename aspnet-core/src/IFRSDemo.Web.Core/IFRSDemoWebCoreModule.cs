...
using IFRSDemo.Web.Authentication.JwtBearer;
using IFRSDemo.Web.Authentication.TwoFactor;
using IFRSDemo.Web.Chat.SignalR;
using IFRSDemo.Web.Configuration;
using IFRSDemo.Web.DashboardCustomization;

namespace IFRSDemo.Web
{
    [DependsOn(
        typeof(IFRSDemoApplicationModule),
        typeof(IFRSDemoEntityFrameworkCoreModule),
    ...
    public class IFRSDemoWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public IFRSDemoWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(IFRSDemoApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(IFRSDemoWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(IFRSDemoWebCoreModule).Assembly);
        }
