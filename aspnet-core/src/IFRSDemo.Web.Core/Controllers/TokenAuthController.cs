...
using IFRSDemo.Authentication.TwoFactor.Google;
...
namespace IFRSDemo.Web.Controllers
{
    ...
    public class TokenAuthController : IFRSDemoControllerBase
    {
