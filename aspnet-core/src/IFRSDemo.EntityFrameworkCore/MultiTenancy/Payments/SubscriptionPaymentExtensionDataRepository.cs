...
{
    public class SubscriptionPaymentExtensionDataRepository : IFRSDemoRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<IFRSDemoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
