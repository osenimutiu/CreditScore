...
{
    public class SubscriptionPaymentRepository : IFRSDemoRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<IFRSDemoDbContext> dbContextProvider)
