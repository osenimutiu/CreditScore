...
namespace IFRSDemo.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = IFRSDemoConsts.MultiTenancyEnabled ? null : (int?)1;
        ...
        public DefaultLanguagesCreator(IFRSDemoDbContext context)
        {
            _context = context;
        }
