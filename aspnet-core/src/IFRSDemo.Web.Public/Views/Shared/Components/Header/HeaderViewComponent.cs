...
using IFRSDemo.Url;
using IFRSDemo.Web.Public.Startup;
using IFRSDemo.Web.Session;

namespace IFRSDemo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : IFRSDemoViewComponent
    {
