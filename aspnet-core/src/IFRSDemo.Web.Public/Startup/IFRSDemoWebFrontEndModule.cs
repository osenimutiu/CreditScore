...
namespace IFRSDemo.Web.Public.Startup
{
    ...
    public class IFRSDemoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public IFRSDemoWebFrontEndModule(IWebHostEnvironment env, IFRSDemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(IFRSDemoWebFrontEndModule).GetAssembly());
        }
    }
}
