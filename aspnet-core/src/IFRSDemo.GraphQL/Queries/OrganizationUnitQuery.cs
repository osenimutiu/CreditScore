...
using IFRSDemo.Core.Base;
using IFRSDemo.Core.Extensions;
using IFRSDemo.Dto;
using IFRSDemo.Types;

namespace IFRSDemo.Queries
{
    public class OrganizationUnitQuery : IFRSDemoQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
