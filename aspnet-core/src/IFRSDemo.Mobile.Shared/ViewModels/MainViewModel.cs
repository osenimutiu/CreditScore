...
using IFRSDemo.Commands;
using IFRSDemo.Core.Threading;
using IFRSDemo.Models.NavigationMenu;
using IFRSDemo.Services.Navigation;
...
using IFRSDemo.ApiClient;
using IFRSDemo.Controls;
using IFRSDemo.Dto;
using IFRSDemo.Extensions;
using IFRSDemo.Localization;
using IFRSDemo.UI;
using IFRSDemo.UI.Assets;
using IFRSDemo.Views;
using DependencyResolver = IFRSDemo.Core.Dependency.DependencyResolver;
...
namespace IFRSDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "IFRSDemo";
