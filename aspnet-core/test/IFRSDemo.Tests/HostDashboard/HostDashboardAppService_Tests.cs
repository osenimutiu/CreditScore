...
using IFRSDemo.MultiTenancy.HostDashboard;
...
namespace IFRSDemo.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(IFRSDemoDbContext context, SubscriptionPayment subscriptionPayment)
        {
